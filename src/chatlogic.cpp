...
ChatLogic::~ChatLogic()
{
    ...
    */
    ...
    // delete all edges
    // TASK 4: Memory deallocation will be automatic with smart pointers
    /*
...
void ChatLogic::LoadAnswerGraphFromFile(std::string filename)
{
            ...
            if (type != tokens.end())
            {
                ...
                if (idToken != tokens.end())
                {
                    ...
                    if (type->second == "NODE")
                    {
                        ...
                        // TASK 3: update to smart pointer format
                        ...
                        if (newNode == _nodes.end())
                        {
                            ...
                            // TASK 3: Use make_unique instead of new
                    ...
                    if (type->second == "EDGE")
                    {
                        ...
                        if (parentToken != tokens.end() && childToken != tokens.end())
                        {
                            ...
                            // TASK 4: make new edge as unique pointer
                            std::unique_ptr<GraphEdge> edge = std::make_unique<GraphEdge>(id);
                            //edge->SetChildNode(*childNode);
                            //edge->SetParentNode(*parentNode);
                            // TASK 3: _nodes are smart pointers, so we use the .get() member function
                            edge->SetChildNode((*childNode).get());
                            edge->SetParentNode((*parentNode).get());
                            
                            //_edges.push_back(edge);
                            // TASK 4: not a private member of ChatLogic
                            //_edges.push_back(edge);
                            ...
                            // TASK 4: use member function get()
    ...
    // Pass handle to ChatLogic
    localChatBot.SetChatLogicHandle(this);
    
    // Pass the local ChatBot instance to graph root node
